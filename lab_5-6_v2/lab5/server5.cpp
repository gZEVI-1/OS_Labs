// ============================================================================
// SERVER5.CPP — TCP-сервер с синхронизацией через события и семафор
// ============================================================================
// Назначение:
//   Сервер принимает подключения от нескольких клиентов (1–10), обрабатывает
//   запросы на конвертацию чисел в двоичную/шестнадцатеричную систему.
//   Синхронизация клиентов выполняется через именованные события Windows
//   и семафор, гарантирующий, что в один момент времени только один
//   клиент активно взаимодействует с сервером.
//
// Архитектура синхронизации:
//   • Семафор "Lab"       — ограничивает число одновременных сессий (1)
//   • Событие "Start"     — клиент сигнализирует о начале своей сессии
//   • Событие "Data"      — клиент сигнализирует о готовности данных
//   • Событие "End"       — клиент сигнализирует о завершении сессии
//
// Протокол обмена:
//   Клиент → Сервер: строка вида "<число> <bin|hex>" или "exit"
//   Сервер → Клиент: строка с результатом конвертации или сообщение об ошибке
// ============================================================================
